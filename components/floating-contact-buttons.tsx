...
export function FloatingContactButtons() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      {/* AI Chat Button */}
      <a
        href="mailto:chatscalendar@gmail.com?subject=Immigration%20Inquiry&body=Hi,%20I%20need%20help%20with%20Mexican%20immigration%20services."
        className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-full p-4 shadow-2xl transition-all duration-300 transform hover:scale-110 flex items-center justify-center group"
        style={{
          width: '64px',
          height: '64px',
