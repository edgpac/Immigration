...
export const metadata: Metadata = {
  title: 'Susana Rapini - Licensed Immigration Consultant Cabo San Lucas | INM Registered',
  description: 'Meet Susana Rapini, licensed INM immigration consultant with 15+ years experience in Mexican immigration law. Specialized in temporary/permanent residency and work permits in Los Cabos.',
  openGraph: {
    title: 'Susana Rapini - Expert Immigration Consultant in Cabo San Lucas',
    description: 'Licensed INM consultant specializing in Mexican immigration. 15+ years experience helping expatriates establish residency in Los Cabos.',
  },
}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl md:text-2xl mb-4 opacity-90">
              Licensed Immigration Consultant & INM Specialist
            </p>
                ...
                <div className="bg-card rounded-lg overflow-hidden border shadow-lg sticky top-8">
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm">INM Licensed</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Languages className="w-5 h-5 text-primary flex-shrink-0" />
                      <span className="text-sm">English, Spanish, Italian</span>
                    </div>
                  </div>
                </div>
              </div>
